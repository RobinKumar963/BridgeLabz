// --------------------------------------------------------------------------------------------------------------------
// <copyright file=PrimeAnagramNumberQueue.cs" company="Bridgelabz">
...
{
    /// <summary>
    /// Prime and Anagram Number in Queue
    /// </summary>
    class PrimeAnagramNumberQueue
    {

        static Utility.Queue<String> queue = new Utility.Queue<String>();
        /// <summary>
        ...
        public static void Main(String[] args)
        {
            ...
            ////Checking 0-100,100-200.....,900-1000 which are both anagram and palindrome
